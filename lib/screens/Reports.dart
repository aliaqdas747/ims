...
class Report_Screen extends StatefulWidget {
  ...
  @override
  State<Report_Screen> createState() => _CategoryScreenState();
}

class _CategoryScreenState extends State<Report_Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Reports',style: const TextStyle(
            color: Colors.white
        ),),
      ),
