...
class Suppliers extends StatefulWidget {
  ...
  @override
  State<Suppliers> createState() => _CategoryScreenState();
}

class _CategoryScreenState extends State<Suppliers> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Suppliers',style: const TextStyle(
            color: Colors.white
        ),),
      ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Image.asset('assets/images/suppliers.png',height: 100,),
                        ],
                      ),
